...
import Question from "../images/Saly-36.png"
import Challenges from '../images/Saly-7.png';
import Opportunities from '../images/Saly-38.png';
...
function CircleFeatures() {
  ...
  <div className="relative sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 mx-auto
      pt-16 pr-4 pb-16 pl-4">
               <h1 className="text-6xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 z-40" data-aos="zoom-y-out">I am an <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">Executive.</span></h1>
    ...
    <div className="relative gap-5 sm:grid-cols-2 lg:grid-cols-3 grid">
      <div className="bg-white text-left transition-shadow duration-200 rounded group hover:shadow-2xl flex flex-col
        ...
        <div className="mt-5 mr-5 mb-5 ml-5">
          <p className="font-bold text-3xl mb-2 ">Rank 1st on the Circle rankings</p>
        </div>
      </div>
      <div className="bg-white text-left transition-shadow duration-200 rounded group hover:shadow-2xl flex flex-col
          justify-between items-center overflow-hidden shadow-xl ml-0">
        ...
        <div className="mt-5 mr-5 mb-5 ml-5">
          ...
          Allow powerful connections can share advice and opportunities
          </p>
        </div>
      </div>
      <div className="bg-white text-left transition-shadow duration-200 rounded group hover:shadow-2xl flex flex-col
        ...
        <div className="mt-5 mr-5 mb-5 ml-5">
          ...
          <p className="font-bold text-3xl mb-2 ">Promote engagement through team challenges</p>
        </div>
      </div>
    </div>
  </div>
