  ...
  <nav className="w-full bg-top bg-cover">
    <div className="max-w-screen-2xl flex-col md:flex-row flex w-full justify-between mt-auto mr-auto mb-auto ml-auto">
      ...
      <div className="md:m-0 md:flex flex flex-row justify-center items-center"><a className="mr-2 ml-2
          ...
          ml-4 block cursor-pointer"><svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
          ...
          h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewbox="0 0 24 24"><path d="M19.633
