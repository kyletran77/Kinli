...
import { getUser, createPost, uploadImage, createCircle, createOpportunities  } from "../firebase/firebase-calls";
import toast from "react-hot-toast";
import {Button} from '@mui/material';
import DropdownList from "react-widgets/DropdownList";
import Combobox from "react-widgets/Combobox"

export default function OppTextEditor({CircleID}) {
...
// filteredData=["ligma"];
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    createOpportunities(currentUser, CircleID, newPost);
